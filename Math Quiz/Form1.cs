...
namespace montymaths
{
    public partial class Form1 : Form
    {
        ...
        /// <summary> 
        /// Call the StartTheQuiz() method and enable the Start button. 
        /// </summary> 
        ...
        public void StartTheQuiz()
        {
            ...
            // Store the values in the variables 'addition1' and 'addition2'.
            addition1 = randomizer.Next(51);
            addition2 = randomizer.Next(51);

            // Convert the two randomly generated numbers into strings so that they can be displayed in the label controls.
            plusLeftLabel.Text = addition1.ToString();
            plusRightLabel.Text = addition2.ToString();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                timer1.Stop();
                MessageBox.Show("You got all the answers right!", "Well done!");
        ...
        {
            if ((addition1 + addition2 == sum.Value)
        ...
        /// <summary> 
        /// Modify the behavior of the NumericUpDown control to make it easier to enter numeric values for the quiz.
        /// </summary> 
